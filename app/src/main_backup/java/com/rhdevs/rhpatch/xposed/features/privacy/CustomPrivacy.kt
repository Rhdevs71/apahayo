...
import com.rhdevs.rhpatch.adapter.CustomPrivacyAdapter
...
class CustomPrivacy(
            ...
            object : WppCore.ActivityChangeState {
                ...
                override fun onChange(activity: Activity, type: WppCore.ActivityChangeState.ChangeType) {
                    try {
                        ...
                        val icon = com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getDrawable(R.drawable.ic_privacy)!!
                        val itemView = createItemView(
                            activity,
                            com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.custom_privacy),
                            com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.custom_privacy_sum),
                            icon
                        )
    ...
    private fun showCustomPrivacyList(
        ...
        if (list.isEmpty()) {
            Utils.showToast(
                com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.no_contact_with_custom_privacy),
                Toast.LENGTH_SHORT
            )
            return
        }
    ...
    private fun createPrivacyDialog(activity: Activity, number: String): AlertDialogWpp {
        ...
        val items = arrayOf(
            com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.hideread),
            com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.hidestatusview),
            com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.hidereceipt),
            com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.ghostmode),
            com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.ghostmode_r),
            com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.block_call)
        )
        ...
        builder.setNegativeButton(com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.cancel), null)
