package com.rhdevs.rhpatch.youtube.youtube.misc.settings
...
import com.rhdevs.rhpatch.youtube.extension.shared.settings.preference.ImportExportPreference
...
import com.rhdevs.rhpatch.youtube.shared.misc.initialization.initializationPatch
...
import com.rhdevs.rhpatch.youtube.shared.settings.preferences
import com.rhdevs.rhpatch.youtube.youtube.layout.buttons.overlay.PlayerOverlayButtonsSettings
...
val SettingsHook = patch(
    ...
    val injectedFragments = java.util.Collections.newSetFromMap(java.util.WeakHashMap<Any, Boolean>())
    ...
    ::PreferenceFragmentCompat_addPreferencesFromResource.hookMethod {
        ...
        before { param ->
            val fragment = param.thisObject ?: return@before
            if (injectedFragments.contains(fragment)) return@before

            val resId = param.args[0] as? Int ?: return@before
            val xml = when (resId) {
                0 -> return@before
            ...
            injectedFragments.add(fragment)
...
object PreferenceScreen : BasePreferenceScreen() {
    ...
    override fun commit(screen: PreferenceScreenPreference) {
        preferences.removeAll { it.key == screen.key }
        preferences += screen
    }
}
