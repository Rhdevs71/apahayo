...
import static com.rhdevs.rhpatch.youtube.extension.shared.ByteTrieSearch.convertStringsToBytes;
import static com.rhdevs.rhpatch.youtube.extension.youtube.patches.LayoutReloadObserverPatch.isActionBarVisible;
...
import com.rhdevs.rhpatch.youtube.extension.shared.ByteTrieSearch;
...
import com.rhdevs.rhpatch.youtube.extension.shared.patches.components.StringFilterGroupList;
        ...
        if (contentType == FilterContentType.PATH) {
            ...
            if (matchedGroup == shortsCompactFeedVideo) {
                return shouldHideShortsFeedItems()
                        ...
                        // See: https://github.com/Morphecom/rhdevs/rhpatch/youtube-patches/issues/773.
