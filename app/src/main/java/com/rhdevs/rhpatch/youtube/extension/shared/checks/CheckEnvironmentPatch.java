package com.rhdevs.rhpatch.youtube.extension.shared.checks;

import static com.rhdevs.rhpatch.youtube.extension.shared.StringRef.str;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.Check.debugAlwaysShowWarning;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_BOARD;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_BOOTLOADER;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_BRAND;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_CPU_ABI;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_CPU_ABI2;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_DEVICE;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_DISPLAY;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_FINGERPRINT;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_HARDWARE;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_HOST;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_ID;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_MANUFACTURER;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_MODEL;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_PRODUCT;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_RADIO;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_TAGS;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_TYPE;
import static com.rhdevs.rhpatch.youtube.extension.shared.checks.PatchInfo.Build.PATCH_USER;
...
public final class CheckEnvironmentPatch {
    ...
    private enum InstallationType {
        ...
        MANAGER("com.rhdevs.rhpatch.youtube.manager",
                "com.rhdevs.rhpatch.youtube.manager.debug");
