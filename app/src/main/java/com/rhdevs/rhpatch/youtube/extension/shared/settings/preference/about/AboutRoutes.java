...
import static com.rhdevs.rhpatch.youtube.extension.shared.settings.preference.about.MorpheAboutPreference.CREDITS_LINK;
...
class AboutRoutes {
    ...
    private static final Route.CompiledRoute GITHUB_ROUTE_PATCHES = new Route(GET,
            (Utils.isPreReleasePatches()
                    ? "/Morphecom/rhdevs/rhpatch/youtube-patches/refs/heads/dev/patches-bundle.json"
                    : "/Morphecom/rhdevs/rhpatch/youtube-patches/refs/heads/main/patches-bundle.json")
    ).compile();
