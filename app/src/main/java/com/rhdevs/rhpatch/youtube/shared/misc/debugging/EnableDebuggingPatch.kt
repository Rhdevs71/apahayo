    ...
    preferences.addAll(
        listOf(
            ...
            NonInteractivePreference(
                ...
                tag = com.rhdevs.rhpatch.youtube.extension.shared.settings.preference.ExportLogToClipboardPreference::class.java,
                selectable = true
            ),
            NonInteractivePreference(
                "morphe_debug_feature_flags_manager",
                tag = com.rhdevs.rhpatch.youtube.extension.shared.settings.preference.FeatureFlagsManagerPreference::class.java,
                selectable = true
            )
        )
    )
