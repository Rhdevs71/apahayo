package com.rhdevs.rhpatch.youtube.extension.shared.settings.preference.about;

import static com.rhdevs.rhpatch.youtube.extension.shared.StringRef.str;
import static com.rhdevs.rhpatch.youtube.extension.shared.settings.preference.about.MorpheAboutPreference.WebLink;
...
import com.rhdevs.rhpatch.youtube.extension.shared.StringRef;
...
class MorpheCreditsDialog extends Dialog {
    ...
    private static final List<WebLink> WORKS_LINKS_CURRENT = List.of(
            new WebLink("Morphe",
                    ...
                    "https://github.com/morphecom/rhdevs/rhpatch/youtube-patches/graphs/contributors"
            )
    );
