...
package com.rhdevs.rhpatch.youtube.youtube.layout.hide.general

import android.view.View
import com.rhdevs.rhpatch.youtube.extension.shared.ResourceUtils.getDimenIdentifier
import com.rhdevs.rhpatch.youtube.extension.shared.ResourceUtils.getIdIdentifier
import com.rhdevs.rhpatch.youtube.extension.shared.ResourceUtils.getLayoutIdentifier
import com.rhdevs.rhpatch.youtube.extension.shared.settings.preference.BulletPointPreference
import com.rhdevs.rhpatch.youtube.extension.youtube.patches.components.CommentsFilter
import com.rhdevs.rhpatch.youtube.extension.youtube.patches.components.CustomFilter
import com.rhdevs.rhpatch.youtube.extension.youtube.patches.components.DescriptionComponentsFilter
import com.rhdevs.rhpatch.youtube.extension.youtube.patches.components.HorizontalShelvesFilter
import com.rhdevs.rhpatch.youtube.extension.youtube.patches.components.KeywordContentFilter
import com.rhdevs.rhpatch.youtube.extension.youtube.patches.components.LayoutComponentsFilter
import com.rhdevs.rhpatch.youtube.extension.youtube.patches.spans.SanitizeVideoSubtitleFilter
import com.rhdevs.rhpatch.youtube.extension.youtube.patches.spans.SearchLinksFilter
import com.rhdevs.rhpatch.youtube.extension.youtube.settings.preference.HTMLPreference
...
import com.rhdevs.rhpatch.youtube.shared.misc.litho.filter.emptyComponentClass
...
import com.rhdevs.rhpatch.youtube.youtube.misc.litho.observer.LayoutReloadObserver
import com.rhdevs.rhpatch.youtube.youtube.misc.navigation.NavigationBarHook
import com.rhdevs.rhpatch.youtube.youtube.misc.playertype.PlayerTypeHook
...
//                        summary = true,
//                        tag = "com.rhdevs.rhpatch.youtube.extension.shared.settings.preference.BulletPointSwitchPreference"
//                    ),
//                    TextPreference(
...
//            summary = true,
//            tag = com.rhdevs.rhpatch.youtube.extension.shared.settings.preference.BulletPointSwitchPreference::class.java,
//        ),
...
//    addSpanFilter(SearchLinksFilter())
    ...
    // TODO hide floating microphone â€” ShowFloatingMicrophoneButtonFingerprint METHOD_MID

    // hide latest videos button
    // layout.content_pill
    // layout.bar

    // TODO hide YouTube Doodles â€” YouTubeDoodlesImageViewFingerprint METHOD_MID (replace setImageDrawable)

    // TODO hide view count â€” HideViewCountFingerprint METHOD_MID (modifyFeedSubtitleSpan)
    ...
    // TODO hide you may like section â€” SearchSuggestionEndpoint/SearchBoxTypingString METHOD_MID (complex helper)
...
*/
    ...
    // TODO hide channel tab â€” ChannelTabBuilder/ChannelTabRenderer METHOD_MID (iterator manipulation)
