...
public class CheckWatchHistoryDomainNameResolutionPatch {
    ...
    public static void checkDnsResolver(Activity context) {
        if (!Utils.isNetworkConnected() || !SharedYouTubeSettings.CHECK_WATCH_HISTORY_DOMAIN_NAME.get()) return;
            ...
            try {
                ...
                Utils.runOnMainThread(() -> {
                    ...
                    Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                            ...
                            () -> SharedYouTubeSettings.CHECK_WATCH_HISTORY_DOMAIN_NAME.save(false),    // Neutral button action (Ignore).
