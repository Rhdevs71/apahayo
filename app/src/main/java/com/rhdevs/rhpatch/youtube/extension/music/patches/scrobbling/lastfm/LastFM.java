...
package com.rhdevs.rhpatch.youtube.extension.music.patches.scrobbling.lastfm;
...
import com.rhdevs.rhpatch.youtube.extension.music.patches.scrobbling.ScrobbleManager;
import com.rhdevs.rhpatch.youtube.extension.shared.Logger;

public class LastFM {
    private static final String BASE_URL = "https://ws.audioscrobbler.com/2.0/";
    private static final String USER_AGENT = "YT Music Morphe (https://github.com/Morphecom/rhdevs/rhpatch/youtube-patches)";
        ...
        ScrobbleManager.getInstance().runOnBackgroundThread(() -> {
            try {
                ...
                if (ex.getErrorCode() == 9) {
                    ...
                    com.rhdevs.rhpatch.youtube.extension.music.settings.Settings.LASTFM_SESSION_KEY.resetToDefault();
                    com.rhdevs.rhpatch.youtube.extension.music.settings.Settings.LASTFM_USERNAME.resetToDefault();
                }
            } catch (Exception ex) {
