...
import com.rhdevs.rhpatch.views.dialog.BottomDialogWpp
import com.rhdevs.rhpatch.xposed.bridge.WaeIIFace
import com.rhdevs.rhpatch.xposed.bridge.client.BaseClient
import com.rhdevs.rhpatch.xposed.bridge.client.BridgeClientKt
import com.rhdevs.rhpatch.xposed.bridge.client.ProviderClientKt
...
object WppCore {
    ...
    @JvmStatic
    fun getContactName(userJid: com.rhdevs.rhpatch.xposed.core.components.FMessageWpp.UserJid): String {
        loadWADatabase()
