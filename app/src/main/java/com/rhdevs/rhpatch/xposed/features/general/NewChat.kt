        ...
        XposedHelpers.findAndHookMethod(
            ...
            object : XC_MethodHook() {
                ...
                override fun afterHookedMethod(param: MethodHookParam) {
                    ...
                    val item = menu.add(0, 0, 0, com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.new_chat))
                    ...
                    item.setOnMenuItemClickListener {
                        ...
                        AlertDialogWpp(activity)
                            .setTitle(com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.new_chat))
                            .setView(view)
                            .setPositiveButton(
                                com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.message)
                            ) { _, _ ->
                            ...
                            .setNegativeButton(com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.cancel), null)
                            .show()
                        true
                    }
                }
