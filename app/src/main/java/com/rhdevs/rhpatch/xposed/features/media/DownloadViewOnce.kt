...
import com.rhdevs.rhpatch.xposed.core.WppCore.viewOnceViewerActivityClass
...
import com.rhdevs.rhpatch.xposed.core.devkit.Unobfuscator.loadViewOnceDownloadMenuMethod
    ...
    companion object {
        ...
        private fun downloadFile(userJid: UserJid?, file: File) {
            ...
            if (TextUtils.isEmpty(error)) {
                Utils.showToast(
                    com.rhdevs.rhpatch.xposed.core.FeatureLoader.moduleContext.getString(R.string.saved_to) + dest,
                    Toast.LENGTH_LONG
                )
            } else {
                Utils.showToast(
