...
class Tasker(loader: ClassLoader, preferences:SharedPreferences) : Feature(loader, preferences) {
    ...
    private fun registerSenderMessage() {
        val filter = IntentFilter("com.rhdevs.rhpatch.MESSAGE_SENT")
        ...
        XposedBridge.hookMethod(method, object : XC_MethodHook() {
            override fun beforeHookedMethod(param: MethodHookParam) {
                ...
                Handler(Utils.application.mainLooper).post {
                    val intent = Intent("com.rhdevs.rhpatch.MESSAGE_RECEIVED")
    ...
    companion object {
        ...
        fun sendTaskerEvent(name: String?, number: String?, event: String) {
            ...
            val intent = Intent("com.rhdevs.rhpatch.EVENT")
            intent.putExtra("name", name)
            intent.putExtra("number", number)
