...
import com.rhdevs.rhpatch.meta.reels.currentClipsHelper
import com.rhdevs.rhpatch.meta.reels.latestPlayingReelUrl
import com.rhdevs.rhpatch.meta.reels.extractAndDownloadReel
...
fun showPikoStyleDownloadMenu(context: Context, activity: android.app.Activity) {
    ...
    Thread {
        ...
        // Prioritaskan Helper Media, Story, atau Reels yang sedang aktif
        val startObj = currentOverflowHelper ?: currentStoryHelper ?: currentClipsHelper ?: findMostVisibleMediaView(activity.window.decorView.rootView as ViewGroup, context)
        ...
        activity.runOnUiThread {
            ...
            // Jika terdeteksi Reels, sertakan opsi unduh Reels HD di posisi teratas
            if (currentClipsHelper != null || latestPlayingReelUrl != null) {
                options.add("Unduh Video Reels (HD)")
