...
val ReelsDownloaderPatch = patch(
    ...
    // 3. Lifecycle listener untuk mereset Clips Helper saat BottomSheet ditutup
    // (Injeksi UI tombol disatukan secara tunggal ke MediaDownloaderPatch agar tidak terjadi duplikasi tombol di Instagram)
    runCatching {
