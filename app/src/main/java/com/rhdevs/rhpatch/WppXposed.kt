...
import com.rhdevs.rhpatch.xposed.AntiUpdater
import com.rhdevs.rhpatch.xposed.bridge.ScopeHook
import com.rhdevs.rhpatch.xposed.core.FeatureLoader
import com.rhdevs.rhpatch.xposed.downgrade.Patch
...
class WppXposed : IXposedHookLoadPackage, IXposedHookInitPackageResources, IXposedHookZygoteInit {
    ...
    override fun handleLoadPackage(lpparam: XC_LoadPackage.LoadPackageParam) {
        ...
        if (packageName == BuildConfig.APPLICATION_ID || packageName == "com.rhdevs.rhpatch" || packageName == "com.rhdevs.rhpatch.w4b" || packageName == "com.rhdevs.rhpatch") {
