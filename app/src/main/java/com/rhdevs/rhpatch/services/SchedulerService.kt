...
import com.rhdevs.rhpatch.receivers.SchedulerReceiver
import java.io.File
...
class SchedulerService : Service() {
    ...
    companion object {
        ...
        private fun sendMessageToWhatsApp(context: Context, message: ScheduledMessage) {
            ...
            val intent = Intent("com.rhdevs.rhpatch.SCHEDULED_SEND").apply {
    ...
    private fun createNotification(content: String): Notification {
        ...
        return NotificationCompat.Builder(this, channelId)
            ...
            .setSmallIcon(com.rhdevs.rhpatch.R.drawable.ic_launcher_new)
