    ...
    public static class GeneralPreferenceFragment extends BasePreferenceFragment {
        ...
        public boolean onPreferenceTreeClick(@NonNull androidx.preference.Preference preference) {
            ...
            if ("message_scheduler_settings".equals(key)) {
                android.content.Intent intent = new android.content.Intent(getContext(), com.rhdevs.rhpatch.activities.MessageSchedulerActivity.class);
                startActivity(intent);
                return true;
            } else if ("auto_reply_settings".equals(key)) {
                android.content.Intent intent = new android.content.Intent(getContext(), com.rhdevs.rhpatch.activities.AutoReplyActivity.class);
                startActivity(intent);
                return true;
            } else if ("custom_folders_settings".equals(key)) {
                android.content.Intent intent = new android.content.Intent(getContext(), com.rhdevs.rhpatch.activities.CustomFoldersActivity.class);
                startActivity(intent);
                return true;
