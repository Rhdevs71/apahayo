package com.rhdevs.rhpatch.ui.fragments.base;
...
public abstract class BasePreferenceFragment extends PreferenceFragmentCompat
    ...
    public void setPreferenceScreen(androidx.preference.PreferenceScreen preferenceScreen) {
        ...
        if (preferenceScreen != null) {
            applyCustomCardLayouts(preferenceScreen);
        }
    }

    private void applyCustomCardLayouts(androidx.preference.PreferenceGroup group) {
        ...
        for (int i = 0; i < group.getPreferenceCount(); i++) {
            ...
            if (pref instanceof androidx.preference.PreferenceCategory) {
                pref.setLayoutResource(R.layout.item_preference_category);
                applyCustomCardLayouts((androidx.preference.PreferenceCategory) pref);
            } else if (!(pref instanceof com.rhdevs.rhpatch.preference.FloatSeekBarPreference)
                    && !(pref instanceof androidx.preference.SeekBarPreference)) {
                pref.setLayoutResource(R.layout.item_preference_card);
                if (pref instanceof androidx.preference.PreferenceGroup) {
                    applyCustomCardLayouts((androidx.preference.PreferenceGroup) pref);
                }
            }
        }
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (getPreferenceScreen() != null) {
            applyCustomCardLayouts(getPreferenceScreen());
        }
        chanceStates(null);
        monitorPreference();
    ...
    private void chanceStates(String key) {
        ...
        // Theme, language, and styling are managed globally by RHPatch
