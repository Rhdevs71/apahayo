...
import com.rhdevs.rhpatch.adapter.RecordingsAdapter;
import com.rhdevs.rhpatch.databinding.FragmentRecordingsBinding;
import com.rhdevs.rhpatch.model.Recording;
import com.rhdevs.rhpatch.ui.dialogs.AudioPlayerDialog;
...
public class RecordingsFragment extends Fragment implements RecordingsAdapter.OnRecordingActionListener {
    ...
    private void initializeBaseDirs() {
        ...
        // 5. Legacy fallback
        addBaseDir(addedPaths, new File(Environment.getExternalStorageDirectory(), "Music/Rhpatch/Recordings"));
    }
